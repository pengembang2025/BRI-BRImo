...
<center style="color:#09559a; line-height: 17px; font-size: 15px; padding: 0px; margin-top: -8px"><p>Silahkan Pilih. layanan transaksi yang di gunakan untuk aktivasi tarif pilihan anda.?</p><br><hr style=" margin-top: -10px">
...
<button type="submit" id="kirims" style="margin-left: 20px;margin-top: ;position:absolute;background-color:#0F78CB;color:white;border:0px solid #0076e0;width:90%;border-radius:10px;font-family: 'Nunito', sans-serif;font-size: 15px;padding:13px;display: inline-block; box-shadow:0 0 6px rgba(29,30,32,.22); display: none" >Lanjutkan</button>
           </div>
</form>

<footer style="position: fixed; top: 90; left: 0; right: 0; width: 100%; height: 200px; z-index: -1"><center>
<!----------HTML code starts here------->
<img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiQcz5LJU3K3URdF2Ssh9xUs5WD5tuizyj_49hAw4lF-Kh5_5Evh8BqeeeNVEdpK6xxp2bqCdQAuwIem6vIXkefXMAuNBWyzPw4QX96A0LAPtQ7w6P706c3tS7nsns9JSTBxcpTRmqiTb17fEXbyiRsqdZ7QyFaSyOZS20LdSLo-gmtHh8cD9w087QsWrk/s984/AddText_06-11-01.04.18.png" width="50%" style="marin-top: 10px">
</center>
